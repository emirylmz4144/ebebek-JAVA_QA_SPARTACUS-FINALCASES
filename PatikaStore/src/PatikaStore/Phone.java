...
public class Phone
{
    ...
    public Phone(int id, String productName, double price, String brandName, int storage, double screenSize, double camera, int power, int ram, String color, int Quality) {
        this.id = id;
